...
CREATE POLICY "Enable Authenticated users access for all operations" ON "public"."products" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Enable all users to order" ON "public"."order_items" USING (true) WITH CHECK (true);



CREATE POLICY "Enable authenticated users to order" ON "public"."orders" USING (true) WITH CHECK (true);
